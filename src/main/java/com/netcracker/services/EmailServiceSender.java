...
public interface EmailServiceSender {
     ...
     void sendMailReminderPersonalCredit(String emailTo, String userName, double amountPaid, String credName, LocalDate date);

     void sendMailReminderFamilyCredit(String emailTo, String userName, double amountPaid, String credName, LocalDate date);
