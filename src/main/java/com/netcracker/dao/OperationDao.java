...
public interface OperationDao {
    ...
    String GET_INCOMES_PERSONAL_AFTER_DATE_BY_ACCOUNT_ID = "SELECT O.OBJECT_ID,  SUMM.VALUE, DATE_OF.DATE_VALUE, CATEGORY.LIST_VALUE_ID" +
    ...
    String GET_EXPENSES_PERSONAL_AFTER_DATE_BY_ACCOUNT_ID = "SELECT O.OBJECT_ID,  SUMM.VALUE, DATE_OF.DATE_VALUE, CATEGORY.LIST_VALUE_ID" +
            " FROM ATTRIBUTES SUMM, ATTRIBUTES DATE_OF, ATTRIBUTES CATEGORY, OBJECTS O, OBJREFERENCE REF" +
