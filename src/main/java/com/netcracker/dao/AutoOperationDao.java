...
public interface AutoOperationDao {
    ...
    String GET_FAMILY_AO = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, AUTO_OPERATION.NAME, " +
            "              FAMILY_DEBIT_ACC.OBJECT_ID AS DEBIT_ID, " +
            "       USERS_REF.REFERENCE AS USER_ID, " +
            "              DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, " +
            "              CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "            FROM OBJECTS AUTO_OPERATION, OBJECTS FAMILY_DEBIT_ACC, LISTS, " +
    ...
    String GET_ALL_TODAY_AO_INCOME_PERSONAL = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, " +
            ...
            "FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
    ...
    String GET_ALL_TODAY_AO_INCOME_FAMILY = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, USER_REF.REFERENCE AS USER_ID, " +
            "       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
    ...
    String GET_ALL_TODAY_AO_EXPENSE_PERSONAL = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, " +
            "       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
            "     OBJREFERENCE DEBIT_REF, ATTRIBUTES DAY_OF_MONTH " +
    ...
    String GET_ALL_TODAY_AO_EXPENSE_FAMILY = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, USER_REF.REFERENCE AS USER_ID, " +
            "       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
            "     OBJREFERENCE DEBIT_REF, ATTRIBUTES DAY_OF_MONTH, OBJREFERENCE USER_REF " +
    ...
    String GET_ALL_AO_INCOME_PERSONAL = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, " +
            "                       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "                       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "                    FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
            "                       OBJREFERENCE DEBIT_REF, ATTRIBUTES DAY_OF_MONTH " +
    ...
    String GET_ALL_AO_INCOME_FAMILY = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, USER_REF.REFERENCE AS USER_ID, " +
            "                       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "                       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "                    FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
            "                       OBJREFERENCE DEBIT_REF, ATTRIBUTES DAY_OF_MONTH, OBJREFERENCE USER_REF " +
    ...
    String GET_ALL_AO_EXPENSE_PERSONAL = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, " +
            "                       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "                       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "                    FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
            "                    OBJREFERENCE DEBIT_REF, ATTRIBUTES DAY_OF_MONTH " +
    ...
    String GET_ALL_AO_EXPENSE_FAMILY = "SELECT AUTO_OPERATION.OBJECT_ID AS AO_OBJECT_ID, DEBIT_REF.REFERENCE AS DEBIT_ID, USER_REF.REFERENCE AS USER_ID, " +
            "       DAY_OF_MONTH.VALUE AS DAY_OF_MONTH, AMOUNT.VALUE AS AMOUNT, CATEGORY.LIST_VALUE_ID AS CATEGORY_ID, " +
            "       LISTS.VALUE AS CATEGORY, DATES.DATE_VALUE AS DATE_OF_CREATION " +
            "FROM OBJECTS AUTO_OPERATION, LISTS, ATTRIBUTES AMOUNT, ATTRIBUTES CATEGORY, ATTRIBUTES DATES, " +
            "     OBJREFERENCE DEBIT_REF, ATTRIBUTES DAY_OF_MONTH, OBJREFERENCE USER_REF " +
