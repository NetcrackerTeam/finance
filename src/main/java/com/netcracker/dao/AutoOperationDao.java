...
public interface AutoOperationDao {
    ...
    String GET_ALL_TODAY_AO_INCOME_PERSONAL =
            ...
            "   AND AUTO_OPERATION.OBJECT_ID = DEBIT_REF.OBJECT_ID AND DEBIT_ACCOUNT.OBJECT_ID = DEBIT_REF.REFERENCE " +
            "   AND USER_REF.ATTR_ID = 1 AND DEBIT_ACCOUNT.OBJECT_ID = USER_REF.REFERENCE AND USERS.OBJECT_ID = USER_REF.OBJECT_ID " +
            "   AND AMOUNT.ATTR_ID = 56 AND CATEGORY.LIST_VALUE_ID = LISTS.LIST_VALUE_ID " +
            "   AND CATEGORY.ATTR_ID = 57 AND DATES.ATTR_ID = 58 AND DEBIT_REF.ATTR_ID = 64 " +
            "   AND DAY_OF_MONTH.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND AMOUNT.OBJECT_ID = AUTO_OPERATION.OBJECT_ID " +
            "   AND CATEGORY.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND DATES.OBJECT_ID = AUTO_OPERATION.OBJECT_ID ORDER BY AO_OBJECT_ID";
    ...
    String GET_ALL_TODAY_AO_INCOME_FAMILY =
            ...
            "   AND DAY_OF_MONTH.VALUE = ? " +
            "   AND AUTO_OPERATION.OBJECT_ID = DEBIT_REF.OBJECT_ID AND DEBIT_ACCOUNT.OBJECT_ID = DEBIT_REF.REFERENCE " +
            "   AND USER_REF.ATTR_ID = 66 AND AUTO_OPERATION.OBJECT_ID = USER_REF.OBJECT_ID AND USERS.OBJECT_ID = USER_REF.REFERENCE  " +
            "   AND AMOUNT.ATTR_ID = 56 AND CATEGORY.LIST_VALUE_ID = LISTS.LIST_VALUE_ID " +
            "   AND CATEGORY.ATTR_ID = 57 AND DATES.ATTR_ID = 58 AND DEBIT_REF.ATTR_ID = 65 " +
            "   AND DAY_OF_MONTH.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND AMOUNT.OBJECT_ID = AUTO_OPERATION.OBJECT_ID " +
            "   AND CATEGORY.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND DATES.OBJECT_ID = AUTO_OPERATION.OBJECT_ID ORDER BY AO_OBJECT_ID";
    ...
    String GET_ALL_TODAY_AO_EXPENSE_PERSONAL =
            ...
            "   AND CATEGORY.ATTR_ID = 51 AND DATES.ATTR_ID = 52 AND DEBIT_REF.ATTR_ID = 59 " +
            "   AND DAY_OF_MONTH.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND AMOUNT.OBJECT_ID = AUTO_OPERATION.OBJECT_ID " +
            "   AND CATEGORY.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND DATES.OBJECT_ID = AUTO_OPERATION.OBJECT_ID ORDER BY AO_OBJECT_ID";
    ...
    String GET_ALL_TODAY_AO_EXPENSE_FAMILY =
            ...
            "   AND DAY_OF_MONTH.VALUE = ? " +
            "   AND AUTO_OPERATION.OBJECT_ID = DEBIT_REF.OBJECT_ID AND DEBIT_ACCOUNT.OBJECT_ID = DEBIT_REF.REFERENCE " +
            "   AND USER_REF.ATTR_ID = 61 AND AUTO_OPERATION.OBJECT_ID = USER_REF.OBJECT_ID AND USERS.OBJECT_ID = USER_REF.REFERENCE " +
            "   AND AMOUNT.ATTR_ID = 50 AND CATEGORY.LIST_VALUE_ID = LISTS.LIST_VALUE_ID " +
            "   AND CATEGORY.ATTR_ID = 51 AND DATES.ATTR_ID = 52 AND DEBIT_REF.ATTR_ID = 60 " +
            "   AND DAY_OF_MONTH.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND AMOUNT.OBJECT_ID = AUTO_OPERATION.OBJECT_ID " +
            "   AND CATEGORY.OBJECT_ID = AUTO_OPERATION.OBJECT_ID AND DATES.OBJECT_ID = AUTO_OPERATION.OBJECT_ID ORDER BY AO_OBJECT_ID";
