...
public interface CreditAccountDao {
    String SELECT_PERSONAL_CREDIT_QUERY = "select distinct cred.OBJECT_ID credit_id, name_at.value name, amount_at.value amount,\n" +
            "  paid_at.value paid, date_at.value date_cr,  rate_at.value credit_rate, \n" +
            "  date_to_at.value date_to, month_day_at.value month_day, is_paid_at.value is_paid,\n" +
    ...
    String SELECT_FAMILY_CREDIT_QUERY = SELECT_PERSONAL_CREDIT_QUERY;
