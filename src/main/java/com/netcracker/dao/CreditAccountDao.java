...
public interface CreditAccountDao {
    ...
    String UPDATE_DATE_FROM = "UPDATE ATTRIBUTES DATE_AT SET DATE_AT.DATE_VALUE = ? WHERE DATE_AT.OBJECT_ID = ? AND DATE_AT.ATTR_ID = 29";
    String UPDATE_RATE = "UPDATE ATTRIBUTES RATE_AT SET RATE_AT.VALUE = ? WHERE RATE_AT.OBJECT_ID = ? AND RATE_AT.ATTR_ID = 33";
    String UPDATE_DATE_TO = "UPDATE ATTRIBUTES DATE_TO_AT SET DATE_TO_AT.DATE_VALUE = ? WHERE DATE_TO_AT.OBJECT_ID = ? AND DATE_TO_AT.ATTR_ID = 34";
    ...
    String SELECT_FAMILY_CREDIT_QUERY = "SELECT CRED.OBJECT_ID CREDIT_ID, NAME_AT.VALUE NAME, AMOUNT_AT.VALUE AMOUNT,\n" +
            ...
            "  DEBT_AMOUNT_AT.VALUE DEBT_AMOUNT, DEBT_REF.OBJECT_ID DEBT_ID, COM_AT.VALUE COMMODITY\n" +
            ...
            "        OBJREFERENCE DEBT_REF, ATTRIBUTES DEBT_DATE_FROM_AT, ATTRIBUTES DEBT_DATE_TO_AT,\n" +
            ...
            "        AND DEBT_REF.OBJECT_ID = DEBT_DATE_FROM_AT.OBJECT_ID\n" +
            "        AND DEBT_REF.OBJECT_ID = DEBT_DATE_TO_AT.OBJECT_ID\n" +
            "        AND DEBT_REF.OBJECT_ID = DEBT_AMOUNT_AT.OBJECT_ID\n" +
    ...
    String SELECT_PERSONAL_CREDITS_BY_ACCOUNT_QUERY = "SELECT CRED.OBJECT_ID CREDIT_ID, NAME_AT.VALUE NAME, AMOUNT_AT.VALUE AMOUNT,\n" +
            ...
            "         ATTRIBUTES IS_PAID_AT, OBJREFERENCE DEBT_REF, ATTRIBUTES DEBT_DATE_FROM_AT,\n" +
    ...
    String SELECT_FAMILY_CREDITS_BY_ACCOUNT_QUERY = "SELECT CRED.OBJECT_ID CREDIT_ID, NAME_AT.VALUE NAME, AMOUNT_AT.VALUE AMOUNT,\n" +
            ...
            "       ATTRIBUTES MONTH_DAY_AT, ATTRIBUTES IS_PAID_AT, OBJREFERENCE DEBT_REF, \n" +
    ...
    String GET_PERSONAL_DEBIT_ID_BY_CREDIT_ID = "SELECT REFERENCE FROM OBJREFERENCE WHERE OBJECT_ID = ? AND ATTR_ID = 27";

    String GET_FAMILY_DEBIT_ID_BY_CREDIT_ID = "SELECT REFERENCE FROM OBJREFERENCE WHERE OBJECT_ID = ? AND ATTR_ID = 28";
