...
public interface FamilyAccountDebitDao {
    ...
    String FIND_FAMILY_ACCOUNT_BY_ID = "SELECT " +
            ...
            +
            "WHERE DEBIT.OBJECT_TYPE_ID = 13 AND US.OBJECT_TYPE_ID = 1 AND PER_DEBIT.OBJECT_TYPE_ID = 2 " +
            "AND DEBIT.OBJECT_ID = ? " +
    ...
    String GET_PARTICIPANTS = "SELECT "
            ...
            +
            "ATTR4_US_PART.LIST_VALUE_ID IS_ACTIVE, PER_DEBIT.OBJECT_ID PER_DEB_ACC1, DEBIT.OBJECT_ID FAM_DEB_ACC1 "
            +
            "FROM OBJECTS DEBIT, OBJECTS US_PART, ATTRIBUTES ATTR1_US_PART, ATTRIBUTES ATTR2_US_PART, ATTRIBUTES ATTR3_US_PART, "
            +
            "ATTRIBUTES ATTR4_US_PART, OBJECTS PER_DEBIT, OBJREFERENCE OBJREF1, OBJREFERENCE OBJREF2  " +
            "WHERE DEBIT.OBJECT_TYPE_ID = 13 AND US_PART.OBJECT_TYPE_ID = 1 AND PER_DEBIT.OBJECT_TYPE_ID = 2" +
            "AND DEBIT.OBJECT_ID = ? " +
