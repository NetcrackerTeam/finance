...
public interface PersonalDebitAccountDao {
    ...
    String GET_INCOME_LIST = "SELECT " +
            ...
            "WHERE DEBIT.OBJECT_TYPE_ID = 2 AND US.OBJECT_TYPE_ID = 1 AND INCOME.OBJECT_TYPE_ID = 21 " +
            "AND DEBIT.OBJECT_ID = ? " +
    ...
    String GET_EXPENSE_LIST = "SELECT " +
            ...
            "WHERE DEBIT.OBJECT_TYPE_ID = 2 AND US.OBJECT_TYPE_ID = 1 AND EXPENSE.OBJECT_TYPE_ID = 20 " +
            "AND DEBIT.OBJECT_ID = ? " +
