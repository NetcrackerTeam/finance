...
public interface PersonalDebitAccountDao {
    ...
    String GET_PERSONAL_ACCOUNT_BY_ID = "SELECT\n" +
            ...
            "            STATUS_USER.LIST_VALUE_ID IS_ACTIVE, USER_TO_PERSONAL.REFERENCE PER_DEB_ACC1, PERSONAL_DEBIT.OBJECT_ID FAM_DEB_ACC1, USER_ROLE.LIST_VALUE_ID AS ROLE\n" +
            ...
            "            ATTRIBUTES STATUS_USER, OBJREFERENCE USER_TO_PERSONAL_DEBIT, OBJREFERENCE USER_TO_PERSONAL, ATTRIBUTES USER_ROLE\n" +
            ...
            "  and USER_ID.OBJECT_ID = USER_ROLE.OBJECT_ID AND USER_ROLE.ATTR_ID = 71";
