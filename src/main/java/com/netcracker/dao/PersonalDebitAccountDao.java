...
public interface PersonalDebitAccountDao {
    ...
    String GET_PERSONAL_ACCOUNT_BY_ID = "SELECT " +
            ...
            +
            "(SELECT FAM_ACC.OBJECT_ID FROM OBJREFERENCE FAM_ACC WHERE USER_ID.OBJECT_ID  = FAM_ACC.REFERENCE AND FAM_ACC.ATTR_ID = 8) as FAM_DEB_ACC1, "
            +
            ...
            "AND USER_ID.OBJECT_ID = USER_TO_PERSONAL.OBJECT_ID " +
