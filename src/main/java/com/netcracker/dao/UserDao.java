...
public interface UserDao {
    ...
    String GET_USER_BY_LOGIN = "SELECT DISTINCT US.NAME OBJ_NAME , EMP_NAME.VALUE NAME,  US_EMAIL.VALUE EMAIL,US.OBJECT_ID AS USER_ID, " +
            ...
            "(SELECT PER_ACC.OBJECT_ID FROM OBJREFERENCE PER_ACC WHERE US.OBJECT_ID  = PER_ACC.REFERENCE AND PER_ACC.ATTR_ID = 1) as PER_DEB_ACC1, " +
            "(SELECT FAM_ACC.OBJECT_ID FROM OBJREFERENCE FAM_ACC WHERE US.OBJECT_ID  = FAM_ACC.REFERENCE AND FAM_ACC.ATTR_ID = 2) as FAM_DEB_ACC1 " +
